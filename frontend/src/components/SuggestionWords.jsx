...
function SuggestionWords() {
  ...
  const handleWordClick = (word) => {
    ...
    <div className="flex flex-col items-center pt-8 w-[672px] h-[95.19px] flex-none order-2 grow-0">
      ...
      <span className=" h-[17px] font-['JetBrains_Mono'] font-normal not-italic text-[11px] leading-[16px] tracking-[1.1px] uppercase text-[#5A5550] flex-none order-none grow-0 text-[20px] mb-6">
        KOKEILE NÄITÄ:</span>
      
      <div className="flex flex-row items-center justify-center gap-2 pt-3 w-[672px] h-[46.19px] flex-none order-1 grow-0">
